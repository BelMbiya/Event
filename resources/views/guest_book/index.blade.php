                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                {{ $guestBooks->where('visibility', 'public')->count() }}
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                {{ $guestBooks->where('visibility', 'private')->count() }}
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                {{ $guestBooks->unique('guest_id')->count() }}
                            </div>
                        </div>
                        <div class="col-auto">
...
function downloadPDF() {
    ...
    window.open(`/guest_book/event/{{ $event->id }}/download-pdf`, '_blank');
}
</script>
@endsection
